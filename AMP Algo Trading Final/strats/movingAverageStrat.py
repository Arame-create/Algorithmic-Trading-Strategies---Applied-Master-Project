...
class movingAverageStrat(autoTrader):
    ...
    def __init__(self, name, short_window, long_window):
        ...
        # Deques to store price history for MA computation
        self.prices = [deque(maxlen=self.long_window+1) for _ in range(asset_count)]
    ...
    def calculate_moving_averages(self, asset):
        # Efficient MA calculation using rolling sums
    ...
    def strategy(self, orderClass):
        ...
        Buy if short MA crosses above long MA, sell if the opposite.
        ...
        for asset in self.asset_list:
            ...
            # Stop-loss condition for long and short positions
        ...
        # Update AUM and filled orders after processing all assets
